...
exports.verifyEmailToken = exports.generateEmailVerificationJwtToken = exports.verifyAuthByHeader = exports.generateJwtToken = exports.AuthError = void 0;
...
const generateEmailVerificationJwtToken = (user, method) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const token = yield new jose_1.SignJWT({
            ...
            .setJti((0, uuid_1.v4)())
            .setIssuedAt()
            .setExpirationTime((_a = process.env.JWT_EMAIL_EXPIRES_IN) !== null && _a !== void 0 ? _a : 0)
            .sign(new TextEncoder().encode(process.env.JWT_SECRET_KEY));
        return token;
    }
    catch (err) {
