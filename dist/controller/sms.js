...
const sendSMSEmail = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const msg = {
            ...
            from: "no-reply@galambo.com", // Change to your verified sender
...
const fotgotPassword = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const token = jsonwebtoken_1.default.sign({ userId: user._id }, (_b = process.env.JWT_SECRET) !== null && _b !== void 0 ? _b : "", {
        expiresIn: "1h",
    });
